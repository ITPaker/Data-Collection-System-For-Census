...
public class DELETE_PROCESS extends javax.swing.JFrame {
    ...
    public DELETE_PROCESS(String username, Connection Dbcon, List<Map<String, String>> dataList) {
    ...
    private void showError(String message) {
         JOptionPane.showMessageDialog(new DELETE_PROCESS.JFrame(), message,"Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        jLabel29.setText("BE GUIDED! IF AN ENTRY GETS DELETED BEFORE BEING VALIDATED AND PASSED TO  THE ADMIN ");
    ...
    String sUrl = "jdbc:mysql://localhost:3306/user_" + username;  // Ensure this is correct
    ...
    try (Connection Dbcon = DriverManager.getConnection(sUrl, sUser, spass)) {
        for (Map<String, String> data : dataList) {
            ...
            String deleteQuery = "DELETE FROM res_info WHERE respondent_email = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DELETE_PROCESS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new DELETE_PROCESS(username, Dbcon, dataList).setVisible(true);
            }
        });
    }
