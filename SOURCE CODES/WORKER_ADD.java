...
public class WORKER_ADD extends javax.swing.JFrame {
    ...
    public WORKER_ADD(String username, Connection Dbcon) {
    ...
    private void initComponents() {
        ...
        w_save_button = new javax.swing.JButton();
        ...
        w_save_button.setBackground(new java.awt.Color(76, 119, 102));
        w_save_button.setFont(new java.awt.Font("Bahnschrift", 1, 12)); // NOI18N
        w_save_button.setForeground(new java.awt.Color(235, 230, 224));
        w_save_button.setText("SAVE");
        w_save_button.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        w_save_button.setPreferredSize(new java.awt.Dimension(80, 25));
        w_save_button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                w_save_buttonActionPerformed(evt);
            }
        });
        ...
        jLabel1.setText("ADD NEW RESPONDENT");
        ...
        PANEL_3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PANEL_3Layout.createSequentialGroup()
                ...
                .addComponent(w_save_button, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    public void UpdateDB(){
        ...
        try{
            ...
            DefaultTableModel RecordTable = (DefaultTableModel)WORKER_DB_FOR_EDIT.record_table.getModel();
    ...
    private void w_save_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_w_save_buttonActionPerformed
        ...
        try {
            ...
            if (isInputValid()) {
                ...
                addRespondent(Dbcon, worker_in_charge, l_name, suffix, f_name, m_name, sex, age, status,
                    birthdate, birthplace, religion, citizenship, profession,
                    address,  email, contact_no, attainment,
                    enumeration_serial, building_serial, housing_unit_serial, household_serial);
                ...
                JOptionPane.showMessageDialog(this, "Respondent is now Successfully Added");
            }
    ...
    }//GEN-LAST:event_w_save_buttonActionPerformed

    
    private void addRespondent(Connection Dbcon, String worker_in_charge, String l_name, String suffix, String f_name, String m_name, 
        ...
        String query1 = "INSERT INTO res_info(respondent_email," + 
                        "f_name, l_name, address, contact_no, household_serial," +
                        "worker_incharge, suffix, m_name, r_sex," + 
                        "r_status, r_age, r_birthdate, r_birthplace, r_religion," + 
                        "r_citizenship, r_profession, r_attainment, enumeration_serial," + 
                        "building_serial, housing_unit_serial, date_listed)" +
                        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
    
        try (PreparedStatement insertaddRespondentStmt = Dbcon.prepareStatement(query1)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WORKER_ADD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WORKER_ADD(username, Dbcon).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField r_profession;
    ...
    private javax.swing.JButton w_save_button;
